...
; expect 8654.655759663223

(/ (/ 0.5 (+ 6743 (* 8456 (- 7 897567)))) 0)
; expect Error
...
(define z (+ 5 8))  ; Defining a name
; expect z

(define (foo z) (+ z 2))  ; Defining a procedure
; expect foo
...
(begin (+ 0 1) (* 96 675) (+ 2 3))
; expect 5

(define z (begin (display '(1/0)) (newline) (print 6) (* 6 5)))
; expect z

; PROBLEM 9 TESTS

(lambda (z t) (* (+ z t) 2))
; expect (lambda (z t) (* (+ z t) 2))
...
(define f (lambda (z t) (* (+ z t) 2)))
; expect f

f
; expect (lambda (z t) (* (+ z t) 2))

; PROBLEM 11 and 12 TESTS

(define (func z t)(define (helper z y)(+ z (* t 3) (* y 4)))(helper z 12))
; expect func

(func 4 5)
; expect 67

(define (func x y)(define (inner z x)(* x (+ y 2) (/ z 3)))inner)
; expect func

((func 1 2) 1 10)
; expect 13.333333333333332
...
(cond ((= 2 3) 5)((< 3 5) 6)((> 8 5) 7)(else 8))
; expect 6

(cond ((< 24 3) 8)((< 7 9) 6)(else 99))
; expect 6
...
(define (accumulate combiner start n term)
  (define (helper combiner start n term val)
  (if (= n 0)
      start
      (helper combiner (combiner start (term val)) (- n 1) term (+ val 1))
      ))
...
(accumulate * 1  109 identity)
; expect 144385958320249358220488210246279753379312820313396029159834075622223337844983482099636001195615259277084033387619818092804737714758384244334160217374720000000000000000000000000
...
;;;define-macro should raise SchemeError if first operand is not a pair
(define-macro not-a-pair
         (list 'map (list 'lambda (list formal) body) iterable))
; expect Error

;;;define-macro should raise SchemeError if operator of first operand is not a scheme symbol 
(define-macro ('not-a-symbol formal iterable body)
         (list 'map (list 'lambda (list formal) body) iterable))
; expect Error
